...
@section('title', 'Sistem Informasi Manajemen Gereja - Dashboard Litbang Klasis')
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Dashboard Litbang Klasis</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Litbang - Dashboard</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="d-flex media-wrapper justify-content-between">
                                <div class="flex-grow-1">
                                    <div class="greeting-user">
                                        ...
                                        <div class="whatsnew-btn"><a class="btn btn-outline-white" href="{{ route('litbang.profile_index') }}"
                                                >View Profile</a></div>
                                    </div>
                                </div>
                                <div>
