    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Sekretaris - Program yang telah ditetapkan di Sidang Jemaat</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Program yang dijalankan dari seksi dan subseksi</p>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div class="mb-3">
                                    <label for="filterSeksi" class="form-label">Filter Berdasarkan Seksi:</label>
                                    <select id="filterSeksi" class="form-select" style="width: 500px;">
                                        <option value="">-- Semua Seksi --</option>
                                        @php
                                            $daftarSeksi = $listProgram->pluck('seksi.nama_seksi')->unique()->sort();
                                        @endphp
