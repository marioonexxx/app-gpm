...
@section('title', 'Sistem Informasi Manajemen Gereja - Dashboard Seksi')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Dashboard Seksi</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="d-flex media-wrapper justify-content-between">
                                <div class="flex-grow-1">
                                    <div class="greeting-user">
                                        ...
                                        <p>Tuhan Yesus Memberkati, Syalom!</p>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1><span class="counter" data-target="45195">{{ $ProgramSeksiCount }}</span></h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1> <span class="counter" data-target="845">{{ $ProgramSeksiApprove }}</span>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1> <span class="counter" data-target="80">{{ $ProgramSeksiPending }}</span></h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1 class="counter" data-target="10905">{{ $MonevSeksiVerifikasiAccept }}</h1>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1> <span class="counter" data-target="80">{{ $ProgramSeksiPrasidang }}</span>
                                            </h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1 class="counter" data-target="10905">{{ $MonevSeksiWaitVerifikasi }}</h1>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1> <span class="counter" data-target="80">{{ $ProgramSeksiReject }}</span></h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1 class="counter" data-target="10905">{{ $MonevSeksiRevisi }}</h1><span
