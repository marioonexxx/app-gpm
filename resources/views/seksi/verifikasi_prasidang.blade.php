    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Seksi Melakukan Verifikasi Usulan Program di Tahapan Pra Sidang Jemaat</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Verifikasi Program Pra Sidang</li>
                        </ol>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <textarea class="form-control" readonly rows="3">{{ $item->indikator }}</textarea>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label"><strong>Kelompok
                                                                    Sasaran</strong></label>
                                                            <textarea class="form-control" readonly rows="3">{{ $item->kelompok_sasaran }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label"><strong>Keterangan
                                                                    Waktu</strong></label>
                                                            <textarea class="form-control" readonly rows="2">{{ $item->keterangan_waktu }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <textarea class="form-control" readonly rows="3">{{ $item->keterangan }}</textarea>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="form-label"><strong>Status Usulan Saat
                                                                    Ini</strong></label><br>
                                                            @switch($item->status_usulan)
                                                                @case('1')
                                                                    <span class="badge bg-success">Tahap Usulan</span>
                                                                @break

                                                                @case('2')
                                                                    <span class="badge bg-success">Tahap Pra Sidang</span>
                                                                @break

                                                                @case('3')
                                                                    <span class="badge bg-success">Program Ditetapkan</span>
                                                                @break

                                                                @case('4')
                                                                    <span class="badge bg-danger">Program Ditolak</span>
                                                                @break
                                                        ...
                                                        <div class="row align-items-end">
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="status_usulan"
                                                                    ...
                                                                    <option value="3"
                                                                        {{ $item->status_usulan == '3' ? 'selected' : '' }}>
                                                                        Penetapan</option>
                                                                    <option value="4"
                                                                        {{ $item->status_usulan == '4' ? 'selected' : '' }}>
                                                                        Tolak</option>
                                                                </select>
                                                            </div>
