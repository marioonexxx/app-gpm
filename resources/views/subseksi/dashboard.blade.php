...
@section('title', 'Sistem Informasi Manajemen Gereja - Dashboard Sekretaris Jemaat')
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Dashboard Sekretaris Jemaat</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1><span class="counter" data-target="45195">{{ $ProgramSubseksiCount }}</span></h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1> <span class="counter" data-target="845">{{ $ProgramSubseksiApprove }}</span>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1> <span class="counter" data-target="80">{{ $ProgramSubseksiPending }}</span></h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1 class="counter" data-target="10905">{{ $MonevSubseksiVerifikasiAccept }}</h1>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1> <span class="counter" data-target="80">{{ $ProgramSubseksiPrasidang }}</span>
                                            </h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1 class="counter" data-target="10905">{{ $MonevSubseksiWaitVerifikasi }}</h1>
                            ...
                            <div class="card widget-1">
                                <div class="card-body">
                                    <div class="widget-content">
                                        ...
                                        <div>
                                            <h1> <span class="counter" data-target="80">{{ $ProgramSubseksiReject }}</span></h1>
                                ...
                                <div class="card widget-1">
                                    <div class="card-body">
                                        <div class="widget-content">
                                            ...
                                            <div>
                                                <h1 class="counter" data-target="10905">{{ $MonevSubseksiRevisi }}</h1><span
