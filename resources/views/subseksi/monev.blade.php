    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>Sub Seksi Melakukan Monitoring dan Evaluasi Program</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                        @foreach ($listProgram as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item->status_monev == 'Waiting')
                                                        <span class="badge rounded-pill badge-warning">Menunggu Input<br> Data Monev</span>
                                                    @elseif ($item->status_monev == 'Ditolak')
                                                        <span class="badge rounded-pill badge-danger">Ditolak</span>
                                                    @elseif ($item->status_monev == 'Disetujui')
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                                        ...
                                                        <i class="fa fa-edit me-1"></i>Input
                                                    </button>
                                                            ...
                                                            <div class="row g-3">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="kesesuaian_waktu" class="form-control"
                                                                        ...
                                                                        <option value="LEBIH AWAL DARI JADWAL">LEBIH AWAL
                                                                            DARI JADWAL</option>
                                                                        <option value="SESUAI JADWAL">SESUAI JADWAL</option>
                                                                        <option value="TERLAMBAT MELEWATI JADWAL">TERLAMBAT
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="tingkat_kes_anggaran" class="form-control"
                                                                        required>
                                                                        <option value="">-- Pilih --</option>
                                                                        <option value="Berlebihan">Berlebihan</option>
                                                                        <option value="Sedikit Berlebihan">Sedikit
                                                                            Berlebihan</option>
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select name="tingkat_par_jemaat" class="form-control"
                                                                        required>
                                                                        <option value="">-- Pilih --</option>
