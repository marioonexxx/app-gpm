...
Route::middleware('auth','verified','Subseksi')->group(function(){
    ...
    Route::put('/subseksi/monev_update_revisi',[SubseksiController::class, 'monev_update_revisi'])->name('subseksi.monev_update_revisi');
...
Route::middleware('auth','verified','Seksi')->group(function(){
    ...
    Route::post('/seksi/verifikasi_monev/{id}',[SeksiController::class, 'monev_verifikasi'])->name('seksi.verifikasi_monev');
    Route::post('/seksi/verifikasi_monev_revisi/{id}',[SeksiController::class, 'monev_verifikasi_revisi'])->name('seksi.verifikasi_monev_revisi');
